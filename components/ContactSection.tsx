...
function FormspreeContactForm({ formId }: { formId: string }) {
  const { t } = useLanguage();
    ...
    <section id="contact" className="py-20 bg-secondary/10 scroll-mt-20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
          ...
          >
            <form
              className="space-y-6 bg-background p-6 rounded-xl border shadow-sm"
...
export default function ContactSection() {
        ...
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <div className="max-w-2xl mx-auto p-6 bg-background rounded-xl border shadow-sm space-y-3">
            ...
            <p className="text-muted-foreground">
              Please email me at{" "}
              <a href={`mailto:${personalInfo.email}`} className="text-primary underline">
                {personalInfo.email}
              </a>{" "}
              or reach out via{" "}
              <a
  ...
  return <FormspreeContactForm formId={formId} />;
}
